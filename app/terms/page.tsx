    ...
    <div className="min-h-screen bg-ivory font-sans text-charcoal selection:bg-taupe selection:text-white">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="max-w-3xl prose prose-headings:text-charcoal prose-a:text-taupe hover:prose-a:text-charcoal prose-strong:text-charcoal">
          ...
          <h2 className="text-2xl text-charcoal mb-4">2. Company Information</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">3. Use of This Website</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">4. Contact Form &amp; Inquiries</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">5. No Cookies or Tracking</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">6. Project Photography</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">7. Estimates &amp; Representations</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">8. Limitation of Liability</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">9. SMS Messaging Terms</h2>
          ...
          <ul className="text-warm-gray mb-6 leading-relaxed list-disc pl-6 space-y-2">
          ...
          <h2 className="text-2xl text-charcoal mb-4">10. Internal App Usage</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">11. Governing Law</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">

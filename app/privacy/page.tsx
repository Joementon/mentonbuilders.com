    ...
    <div className="min-h-screen bg-ivory font-sans text-charcoal selection:bg-taupe selection:text-white">
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="max-w-3xl prose prose-headings:text-charcoal prose-a:text-taupe hover:prose-a:text-charcoal prose-strong:text-charcoal">
          ...
          <h2 className="text-2xl text-charcoal mb-4">2. Information We Collect</h2>
          ...
          <h2 className="text-2xl text-charcoal mb-4">3. How We Use Your Information</h2>
          <p className="text-warm-gray mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">4. SMS Messaging (Text Messages)</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">5. Data Storage and Security</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">6. Third-Party Service Providers</h2>
          <p className="text-warm-gray mb-4 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">7. Employee Rights</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">9. Data Retention</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">10. Changes to This Policy</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
          ...
          <h2 className="text-2xl text-charcoal mb-4">11. Contact Us</h2>
          <p className="text-warm-gray mb-6 leading-relaxed">
